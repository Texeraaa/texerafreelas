          ...
          <div className="relative glass-card rounded-2xl p-8 shadow-elegant">
            <div className="space-y-6">
              ...
              <div className="space-y-3 font-mono text-sm">
                ...
                <div className="ml-4 text-card-text">frontend: [&apos;ReactJs&apos;, &apos;Next.js&apos;, &apos;TypeScript&apos;, &apos;VueJs&apos;],</div>
                <div className="ml-4 text-card-text">backend: [&apos;Node.js&apos;, &apos;PostgreSQL&apos;, &apos;MongoDB&apos;],</div>
                <div className="ml-4 text-card-text">cloud: [&apos;AWS&apos;, &apos;Vercel&apos;, &apos;Docker&apos;],</div>
